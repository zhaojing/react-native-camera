...
public class CameraViewManager extends ViewGroupManager<RNCameraView> implements LifecycleEventListener {
    private static final String TAG = CameraViewManager.class.getSimpleName();
    private RNCameraView mRNCameraView = null;
    ...
    @Override
    public void receiveCommand(RNCameraView root, int commandId, @javax.annotation.Nullable ReadableArray args) {
    ...
    protected RNCameraView createViewInstance(ThemedReactContext themedReactContext) {
        mRNCameraView = new RNCameraView(themedReactContext);
        return mRNCameraView;
    }
